...
public class GoWaterAction : GoapAction { 
    ...
    public GoWaterAction() { 
        addEffect("goDrink", true);
        addPrecondition("foundWater", true);
    }
    ...
    public override bool checkProceduralPrecondition(GameObject agent) {
        if (_agentData.Memory.waterSourceHistory == null) { 
            return false;
        }
    ...
    private void Redo() {
        ...
        _pathProgress = 0;
        _path = null;
        _targetPos = _agentData.Memory.waterSourceHistory.CenterPosition;
