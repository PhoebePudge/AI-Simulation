...
public sealed class GoapAgent : MonoBehaviour {
	...
	private FinitestateMachine.FSMState idleState; // finds something to do
	private FinitestateMachine.FSMState moveToState; // moves to a target
	private FinitestateMachine.FSMState performActionState; // performs an action
